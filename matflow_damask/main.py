...
def read_damask_hdf5_file(hdf5_path, incremental_data, field_data, operations=None):
    return read_HDF5_file(hdf5_path, incremental_data, field_data, operations=operations)
